    ...
    <section id="contact" className="py-32 px-6 bg-card">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <p className="text-muted-foreground text-lg mb-10 leading-relaxed">
          Хотите узнать больше о проекте, пригласить на выставку или обсудить сотрудничество? Напишите — Екатерина ответит.
        </p>

        {submitted ? (
          <div className="p-8 rounded-2xl bg-sage/10 border border-sage/20">
            <p className="text-foreground font-serif text-2xl mb-2">Сообщение отправлено</p>
            <p className="text-muted-foreground">Екатерина скоро ответит на ваше письмо.</p>
          </div>
        ) : (
